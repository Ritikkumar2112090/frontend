...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      details: ["Vrindavan, Mathura", "Uttar Pradesh - 281121"],
    },
    {
      icon: Phone,
      title: "Phone Numbers",
    ...
    },
    {
      ...
      details: ["vrindavansaathi@gmail.com"],
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://backend-p40q.onrender.com/api/complaints", {
        method: "POST",
        headers: {
      ...
      toast({
        ...
        description:
          "Thank you for contacting us. Your inquiry has been recorded and we'll respond within 24 hours.",
      });
